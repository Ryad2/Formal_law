...
\begin{tikzpicture}[x=0.96mm,y=0.80mm,>=Stealth,transform shape]
  ...
  \node[greenbox,text width=82mm] (local) at (184,-42) {Local alignment\\Smith--Waterman\\tolerant PMI};
...
\vspace{3mm}
\begin{whitebox}[height=56mm]
\textbf{Alignment layer.}\\[-1mm]
{\smallfont
\begin{tabularx}{\linewidth}{@{}L{0.31\linewidth}Y@{}}
\toprule
\textbf{Global} & Aligns the whole interval sequences and penalizes gaps: useful for overall resemblance.\\
\textbf{Local} & Finds the best matching subsequence: useful when alleged copying is a recognizable fragment.\\
\bottomrule
\end{tabularx}}
\end{whitebox}
